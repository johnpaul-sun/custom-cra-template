 ...
 *  
[ 
  import Home from "./Home"; basically says that... 
  
  Import the folder "./Home" and name it Home or what ever you want to call your Route.
  It was like a key value pair or like a variable named after the import with the value from, from.
]
 * 
[ 
  export { Home }; basically says that... 

  From the Home folder, export the imported file named Home.
...
[ 
  ...
  Then use dot notation to get the value you're looking for "<Routes.Home />".
